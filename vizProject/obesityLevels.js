...
var rowConverter = function (d) {
	return {
		...
		maleCategory4: parseFloat(d.maleCategory4),
		femaleCategory4: parseFloat(d.femaleCategory4),
	};
}
...
d3.csv("cansim2.csv", rowConverter, function (data) {
	...
	lineGen4 = d3.line()
		.x(function (d) { return xScale(d.when) })
		.y(function (d) { return yScale(d.level4) });
...
var update2 = function () {
	...
	xScale.domain(d3.extent(dataset, function (d) { return d.when; }));
	yScale.domain(d3.extent(dataset, function (d) { return d.level4; }));
	svg.selectAll("circle")
		.data(dataset)
		.transition()
		.duration(1000)
	...
	svg.selectAll("circle").on("mouseover", function (d) {
		...
		d3.select("#tooltip")
			...
			.style("top", yPosition + "px")
			.select("#value")
			.html("Percentage: " + d.level4 + "%" + "<br/>" + "Male: " + d.maleCategory4 + "%" + "<br/>" + "Female: " + d.femaleCategory4 + "%" + "<br/>" + " Province: " + d.symbol);
	...
	svg.selectAll("path")
		...
		.delay(200)
		.style("stroke", function (d) { return colorScale(d.key); })
		.attr("d", function (d) { return lineGen4(d.values) });
...
var update3 = function () {
	...
	svg.selectAll("circle").on("mouseover", function (d) {
		...
		d3.select("#tooltip")
			...
			.style("top", yPosition + "px")
			.select("#value")
			.html("Percentage: " + d.level2 + "%" + "<br/>" + "Male: " + d.maleCategory2 + "%" + "<br/>" + "Female: " + d.femaleCategory2 + "%" + "<br/>" + " Province: " + d.symbol);
...
var update4 = function () {
	...
	svg.selectAll("circle").on("mouseover", function (d) {
		...
		d3.select("#tooltip")
			...
			.style("top", yPosition + "px")
			.select("#value")
			.html("Percentage: " + d.level3 + "%" + "<br/>" + "Male: " + d.maleCategory3 + "%" + "<br/>" + "Female: " + d.femaleCategory3 + "%" + "<br/>" + " Province: " + d.symbol);
